...
$a="SELECT id_esp, espaci from esp ORDER BY id_esp";
...
<header class="p-3 text-bg-dark">
    ...
    <form action="/subir.php" method="post" enctype="multipart/form-data">
        <h4 class="mb-3">alquiler de espacios deportivos</h4>
        <form class="needs-validation" novalidate>
          
            
              ingrese su espacio
            <select name="tip">
                <option value = "0">elegi un tipo de espacio</option>
                <?php
             while($o=$h->fetch_assoc()) {
                echo "<option value='".$o["id_esp"]."'>".$o["espaci"]."</option>";
             }
            ?>
            </select>
            </div>
