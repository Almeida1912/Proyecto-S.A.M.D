...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['registrar'])) {
    ...
    $mail = $conexion->real_escape_string($_POST['gmail']);

    // Asegúrate de que los campos no estén vacíos
    if (!empty($nombre) && !empty($email)) {
        $sql = "INSERT INTO  login (nombre, apellido, fecha, gmail) VALUES ('$nombre','$apellido','$fecha', '$mail')";
...
<form action="../validralog.php" method="post" class="">
<header class="p-3 text-bg-dark">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-center me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="ini.php" class="nav-link px-2 text-white">productos</a></li>
    ...
    <center>
    <form action="..\sitio\subi.php" method="post">
    <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">registrarse</h4>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="gmail" class="form-label">Correo Electronico <span class="text-body-secondary"></span></label>
              <input type="gmail" class="form-control" id="gmail"  name="gmail" placeholder="Ejemplo@hotmail.com">
              <div class="invalid-feedback">
