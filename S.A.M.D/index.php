    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="../S.A.M.D/sitio/ini.php" class="nav-link px-2 text-white">productos</a></li>
        ...
        <div class="text-end-a">
          <button type="button" class="btn btn-outline-light me-2"><a href="../S.A.M.D/sitio/login.php" style="color: white"><svg xmlns="http://www.w3.org/2000/svg" height="30" width="13" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>  registrarse</a></button>
          <button type="button" class="btn btn-warning me-2"><a href="../S.A.M.D/html/valid.html" style="color:black;"><svg xmlns="http://www.w3.org/2000/svg" height="30" width="18" viewBox="0 0 640 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3zM625 177L497 305c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L591 143c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>iniciar sesion</a></button>
        </div>
...
<a href="../S.A.M.D/sitio/ini.php" class="nav-link px-2 text-white text-center"><h3>Registre los productos</h3></a>
  <!-- Three columns of text below the carousel -->
  
  <div class="album py-5 bg-body-tertiary">
    <div class="container">

          <div class="row flex- row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 ">
          <?php
        ...
        <div class="col bg-white mx-2 card shadow-sm">
            ...
            <?php echo "<img src='img/".$fila['imagen']."' width=100%'>"?>
              ...
              <button type="button" class="btn btn-sm btn-outline-secondary"><?php echo $fila['alf']?></button>
               </div>
                <!-- Product price-->
                <small class="text-body-secondary-col-black"> $<?php echo $fila['alp']?></small>
                 </div>
                 </div>
  ...
  <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
    ...
    <div class="col mb-3 text-white">
      ...
      <ul class="nav flex-column">
        <li class="nav-item mb-2"><a href="../S.A.M.D/sitio/inf.php" class="nav-link p-0 text-body-secondary">como comprar</a></li>
        <br>
...
<script src="../S.A.M.D/js/bootstrap.bundle.min.js"></script>
